; Override for tree-sitter-vim 0.7.0 compatibility
; Removes "substitute" keyword which is not supported by current parser
...
; NOTE: "substitute" removed for tree-sitter-vim 0.7.0 compatibility
[
  "let"
  "unlet"
  "const"
