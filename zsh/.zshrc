...
# This sets up keybindings like Ctrl+T (files), Ctrl+R (history), Alt+C (directories)
if [[ -f ~/.fzf.zsh ]]; then
  source ~/.fzf.zsh
else
...
# Heroic launcher satisfactory screenshots
...
# Source all scripts from ~/.zshrc.d (if you copy/symlinked your bashrc.d)
if [[ -d ~/.zshrc.d ]]; then
